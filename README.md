...
Our apps use some third-party libraries (Android Advertising ID, Advertising Identifier for iOS, Firebase services) which can collect some information from you. You can check their Private Policy:
